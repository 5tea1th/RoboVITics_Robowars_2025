                            ...
                            return Container(
                              ...
                              child: Chip(
                                ...
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(20),
                                  side: const BorderSide(color: Color(0xFF9D3AE7), width: 1),
                                ),
                              ),
                            );
                          }).toList(),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          // Team logo
                          Container(
                            width: (screenWidth - 80) * 0.2, // ~1/5 of right container
                          ...
                          Expanded(
                            child: Row(
                              ...
                              children: [
                                _buildStatColumn("Matches", "${team['matches']}"),
                          ...
                          children: team['bots'].map<Widget>((bot) {
                            return Padding(
                              ...
                              child: Chip(
                                ...
                                backgroundColor: const Color.fromARGB(255, 30, 22, 35),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(20),
